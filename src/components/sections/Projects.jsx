        ...
        <div className="max-w-5xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30
                    ...
                    <h3 className="text-xl font-bold mb-2"> Calculate_entropy_and_weight_avg_entropy</h3>
                    <p className="text-gray-400 mb-4">
                        for calculate entropy equation and weight average entropy
                    </p>
                    <div>
                        {["Python"].map((tech, key) => (
                    ...
                    <div className="flex justify-between items-center">
                        <a href="https://github.com/panuza1/calculate_entropy_and_Weigh_Avg_Ent" className="text-blue-400 hover:text-blue-300 transition-colors my-4">
                            {" "}
                            View Project → {" "}
                        </a>
                    </div>
